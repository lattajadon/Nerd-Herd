...
public class Math extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.nerdherd/databases/";
    private static final String Database_name = "math.db";//NAME of database stored in Assets folder
    private static final String Table_name = "MathQuestions";//name of table
    private static final String uid = "id";
    private static final String Question = "question";
    private static final String OptionA = "answer1";
    private static final String OptionB = "answer2";
    private static final String OptionC = "answer3";
    private static final String Answer = "correctAnswer";
    ...
    public Math(Context context) {//constructor
    ...
    public int readAnswer(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        int Ans = 0;//string that contains the required field
